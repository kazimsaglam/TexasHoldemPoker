...
public class DeckManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        GameController.instance.EndOfTour += PlaceholderBoardTransformChange;
        deck = listOfCards;
        deck.Shuffle();
    }
    ...
    public void PlaceholderBoardTransformChange()
    {
        placeholderBoard.transform.position = EndOfTourPanel.instance.placeholderBoard.transform.position;
    }
}